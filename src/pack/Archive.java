...
public class Archive {
    ...
    {
        if (changeCategory || notAskedQuestions.size() == 0)
        {
    ...
    final private ArrayList<Question> geographyQuestions =  new ArrayList<Question>()
    {{
    ...
    final private ArrayList<Question> cinematographyQuestions = new ArrayList<Question>()
    {{
    ...
    final private ArrayList<Question> jokes = new ArrayList<Question>()
    {{
